...
app_id=<app-id-here> # e.g. 12345 - Update with your app ID
app_private_key="$(< <path-to-your-private-key-here>)" # e.g. ~/.ssh/app.2019-08-29.private-key.pem - Update with your private key
